...
/**
 * This is the item provider adapter for a {@link de.generia.tools.model.api.EParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EParameterItemProvider
	...
	public String getText(Object object) {
		EParameter lParameter = (EParameter)object;
		String lText = lParameter.getName();
		EClassifier lType = lParameter.getType();
		if (lType == null) {
			return lText + " : null";
		}
		String lTypeText = lType.getName();
		if (lParameter.isMany()) {
			lTypeText = getCollectionType(lParameter) + "<" + lTypeText + ">";
		}
		return lText + " : " + getMapType(lParameter, lTypeText);
	}
