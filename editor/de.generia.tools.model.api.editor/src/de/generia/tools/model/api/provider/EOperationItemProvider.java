...
/**
 * This is the item provider adapter for a {@link de.generia.tools.model.api.EOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EOperationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EOperation_exceptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EOperation_exceptions_feature", "_UI_EOperation_type"),
				 ApiPackage.Literals.EOPERATION__EXCEPTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApiPackage.Literals.EOPERATION__PARAMETERS);
		}
	...
	public String getText(Object object) {
		EOperation lOperation = (EOperation)object;
		String lText = lOperation.getName();
		EClassifier lType = lOperation.getType();
		if (lType == null) {
			return lText + " : void";
		}
		String lTypeText = lType.getName();
		if (lOperation.isMany()) {
			lTypeText = getCollectionType(lOperation) + "<" + lTypeText + ">";
		}
		return lText + " : " + getMapType(lOperation, lTypeText);
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApiPackage.Literals.EOPERATION__PARAMETERS,
				 ApiFactory.eINSTANCE.createEParameter()));
	}
